...
## Gotchas
  ...
  * **Existing transition properties will be overridden.** I am hoping to change this in a future version, but at present, Flip Move does not take into account existing `transition` CSS properties on its direct children.
